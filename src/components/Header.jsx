...
function Header() {
  return (
    <div className="bg-gradient-to-r from-blue-500 to-green-500 text-white px-28 flex flex-col gap-2 md:gap-0 md:flex-row items-center justify-between py-2 font-medium">
      {/* // First Container  */}
      ...
      {/* <div className="flex flex-row gap-8">
        <p
          ...
          onClick={() =>
            window.open(
              "https://www.facebook.com/sumant.jha.75?mibextid=kFxxJD",
              "_blank"
            )
          }
        >
        ...
        <p
          style={{ cursor: "pointer" }}
          onClick={() => window.open("https://x.com/AdvSumant?s=08", "_blank")}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            version="1.1"
        ...
        <p
          ...
          onClick={() =>
            window.open(
              "https://api.whatsapp.com/send?phone=9507004875",
              "_blank"
            )
          }
        >
        ...
        <p
          ...
          onClick={() =>
            window.open(
              "https://www.instagram.com/sumantj6?igsh=MTd6cHpmOG5zY3BxbA%3D%3D&utm_source=qr",
              "_blank"
            )
          }
        >
